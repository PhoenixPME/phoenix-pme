# Welcome to PhoenixPME Discussions!
...
- **Q&A**: Technical questions (please search first!)
- **Show and tell**: Contributor showcases

## 🚫 What NOT to Do
- Don't expect immediate responses (we're async)
- Don't use real-time chat expectations
- Don't post duplicate questions (search first)

## ✅ What TO Do
- Be patient with responses (48h typical)
- Provide detailed context in questions
